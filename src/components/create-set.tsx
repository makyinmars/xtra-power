...
const CreateSet = ({exerciseId}: SetProps) => {
				...
				>
					...
					<div className='fixed inset-0 overflow-y-auto'>
						<div className='flex min-h-full items-center justify-center p-4 text-center'>
							...
							>
								<Dialog.Panel className='w-full max-w-md transform overflow-hidden rounded-2xl bg-stone-300 p-6 text-left align-middle shadow-xl transition-all'>
									<Dialog.Title
										as='h3'
									...
									<div className='mt-2'>
										...
										>
													...
													>
														...
														<div className='col-span-2 flex justify-center'>
															<button
																...
																className='button hover:bg-blue-400 w-full'
															>
																Remove Set
															</button>
														</div>
											...
											<div className='dark:blue-900 flex items-center justify-center gap-4 rounded py-2'>
												...
												<button className='button w-full'>Save Sets</button>
											</div>
										</form>
									</div>
